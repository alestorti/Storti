...
// ── FUNDO ─────────────────────────────────────────────────────
function drawBg(rd) {
  // Canvas é transparente — limpa sem fill para deixar o CSS bg aparecer
  ctx.clearRect(0, 0, SIZE, SIZE);

  // Anéis semi-transparentes — a imagem CSS aparece nos "buracos" entre eles
  const layers = [
    { r: rd.outer,     f: 'rgba(7,20,40,0.55)' },
    { r: rd.grpOuter,  f: 'rgba(9,22,45,0.52)' },
    { r: rd.grpInner,  f: 'rgba(7,20,40,0.55)' },
    { r: rd.r32Ring,   f: 'rgba(9,22,45,0.52)' },
    { r: rd.r16Ring,   f: 'rgba(7,20,40,0.55)' },
    { r: rd.qfRing,    f: 'rgba(9,22,45,0.52)' },
    { r: rd.semiRing,  f: 'rgba(7,20,40,0.55)' },
    { r: rd.finalRing, f: 'rgba(9,22,45,0.52)' },
    { r: rd.innerGlow, f: 'rgba(7,20,40,0.62)' },
  ];
